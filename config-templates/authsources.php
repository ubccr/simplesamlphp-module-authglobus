...
$config = array(
    ...
    // Simply copy paste this stuff (uncommented) into your own authsources.php
    // Depending on how your application is set up, you may need to use Globus as an IDP
    // instead of an SP.
    /*
   	'globus' => array(
		'globus:Globus',
		...
		'scope' => 'the appropriate scopes, you should have set these up when registering your app',
		'response_type' => 'code',
		'redirect_uri' => 'https://yourwebsite.example.com/simplesaml/module.php/globus/linkback.php'
	)*/
